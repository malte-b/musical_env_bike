...
// 2 Paper [[12]](#sonification-of-air-pollution-data-1) and [[18]](#sonification-of-air-pollution-data-1)
...
The sonification by Kasper Fangel Skov [[17]](#sonification-of-air-pollution-data-1) is concerned about climate and human health as well but focuses not on ozone but on dimensions like temperature, light, humidity, and noise. Interestingly this sonification of urban environmental data of different cities also uses voice to classify the used data in categories like "high" or "medium".
...
Apart from the sonification projects described above, we got inspiration by the *Sonic Kayak* [[15]](#sonification-of-air-pollution-data-1) and the *Sonic Bike* [[19]](#sonic-bikes) [[20]](#sonic-bikes) [[21]](#sonic-bikes) projects. Both projects were introduced to us by *Kaffe Matthews* who works on these topics for many years.  
