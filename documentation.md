...
Air pollution is generated by emmisions from road traffic, power plants, furnaces or heaters in residential buildings, and many more sources [[2]](#air-pollution). Most air pollution is produced by human activity, even though it brings critical health and climate problems.  
...
The 'Sonic Bike Project' is concerned about exactly this topic. The goal is to hear and understand sonified air pollution data while riding a bike. The black bikes look quite natural but have an air pollution sensor as well as hardware and speakers attached to the bike, so that the cyclist can independently ride around. While riding, the sensor is measuring the particulate matter and this life data is directly sonified and presented to the cyclists via the speakers.

We joined the project after meeting *Kaffe Matthews*. Together with two colleagues she already introduced the *Sonic Bikes* to the public in Lisboa and plans the next *Sonic Bike* event in Great Britain in summer 2021. The *Sonic Bike Project* is concerned about raising the awareness of air pollution, gather environmental data and attract attention of other pedestrians. They aim to communicate the gathered data in an interesting, artistic way. But at the same time the cyclist should intuitively understand the data so that the sound should be meaningful, and informative as well.  
...
Regarding the project outcome we are interested how we are able to translate data to sound that the cyclist can intuitively understand. We aim to raise awareness of air pollution but have a sound that is interesting enough to ride the bike for a longer period of time. Towards the end of the project, we asked ourselves what air pollution sounds like and still discover this question with different samples we recorded ourselves.
